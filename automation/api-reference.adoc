...
---
= Référence de l'API REST des ONTAP tools
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
.Étapes
. Saisissez l'URL suivante dans votre navigateur, en remplaçant la variable par l'adresse IP et la combinaison de port appropriée, puis appuyez sur *Entrée*.
+
`\https://$FQDN_IP_PORT/`
