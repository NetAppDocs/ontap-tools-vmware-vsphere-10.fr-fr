...
| 200 | OK | Indique le succès des appels qui ne créent pas de nouvelle instance de ressource. 
...
| 404 | Introuvable | La ressource référencée dans la demande n'existe pas. 
