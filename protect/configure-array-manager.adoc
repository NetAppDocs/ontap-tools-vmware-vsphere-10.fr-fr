...
summary: 'Configurez SRA avec l"assistant VMware Live Site Recovery Array Manager pour connecter les sites protégés et de récupération aux machines virtuelles de stockage.' 
---
= Configurez SRA à l'aide du gestionnaire de baies dans ONTAP tools
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
