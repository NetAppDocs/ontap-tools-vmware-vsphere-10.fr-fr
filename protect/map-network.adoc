...
summary: Cartographiez les réseaux entre les sites protégés et les sites de récupération afin d’aligner la connectivité des machines virtuelles lors du basculement de VMware Live Site Recovery. 
---
= Configurer les mappages réseau dans ONTAP tools
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
