...
summary: Créez des groupes de protection pour les machines virtuelles du site protégé et mettez à jour la découverte du stockage après avoir ajouté des datastores aux volumes protégés. 
---
= Associez les sites et configurez les groupes de protection dans les outils ONTAP
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Même version de VLSR installée
