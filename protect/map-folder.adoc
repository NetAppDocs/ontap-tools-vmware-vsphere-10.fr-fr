...
summary: Associez les dossiers entre les sites protégés et les sites de récupération afin de préparer les workflows de basculement VMware Live Site Recovery. 
---
= Configurer les mappages de dossiers dans ONTAP tools
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Résultat
La page « Mappage des dossiers » affiche les ressources du site protégé et celles du site de récupération. Vous pouvez suivre la même procédure pour les autres dossiers de votre environnement.
