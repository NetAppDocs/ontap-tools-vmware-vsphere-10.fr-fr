...
summary: 'Configurez SRA sur l"appliance VMware Live Site Recovery pour activer les flux de travail de reprise après sinistre avec les outils ONTAP.' 
---
...
* Activez les services SRA dans ONTAP tools Manager. Pour plus d'informations, consultez la link:../manage/enable-services.html["Activer les services"] section.
* Ajoutez des serveurs vCenter à l'appliance ONTAP tools for VMware vSphere. Pour plus d'informations, consultez la section link:../configure/add-vcenter.html["Ajouter des serveurs vCenter"].
* Ajoutez des systèmes de stockage à ONTAP tools for VMware vSphere. Pour plus d'informations, consultez la link:../configure/add-storage-backend.html["Ajouter des backends de stockage"] section.
