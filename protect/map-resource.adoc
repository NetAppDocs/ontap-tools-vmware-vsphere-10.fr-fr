...
summary: 'Associez les pools de ressources, les hôtes ou les clusters entre les sites protégés et les sites de récupération afin de placer correctement les machines virtuelles lors d"un basculement.' 
---
= Configurer les mappages de ressources dans ONTAP tools
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
.. Sélectionnez *Préparer automatiquement les mappages pour les ressources ayant des noms correspondants* et sélectionnez *Suivant*.
...
.Résultat
La page « Mappages de ressources » affiche les ressources du site protégé et celles du site de récupération. Vous pouvez suivre la même procédure pour les autres ressources de votre environnement.
