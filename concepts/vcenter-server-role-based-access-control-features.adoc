...
Vous pouvez afficher les outils ONTAP pour les rôles standard VMware vSphere en sélectionnant *Roles* sur la page d'accueil de vSphere client. Les rôles fournis par les outils ONTAP pour VMware vSphere vous permettent d'effectuer les tâches suivantes :
