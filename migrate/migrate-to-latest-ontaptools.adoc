...
. Installez les outils ONTAP pour l'adaptateur VMware vSphere 10.2 SRA sur les sites de protection et de reprise en suivant la procédure décrite à la section link:../protect/configure-on-srm-appliance.html["Configurez SRA sur l'appliance SRM"]
