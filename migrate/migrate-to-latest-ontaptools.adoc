...
. Ajoutez les outils ONTAP pour le fournisseur de stockage VMware vSphere 10.1 au serveur vCenter et link:../configure/registration-process.html["Enregistrez VASA Provider sur vCenter Server"].
...
+
Une fois l'ancien fournisseur VASA arrêté, vCenter Server bascule vers les outils ONTAP pour VMware vSphere 10.1. Tous les datastores et machines virtuelles sont accessibles et sont servis à partir des outils ONTAP pour VMware vSphere 10.1.
