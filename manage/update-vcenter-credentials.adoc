...
Si vous avez modifié les informations d'identification de vCenter Server, ONTAP ou Data LIF après le déploiement, mettez-les à jour en suivant cette procédure.
