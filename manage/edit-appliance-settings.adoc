...
---
= Modifier les paramètres de l'appliance ONTAP tools
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
Assurez-vous que chaque hôte ESXi ne contient qu'une seule machine virtuelle ONTAP tools. Les entrées sont validées à chaque passage à la fenêtre suivante.
