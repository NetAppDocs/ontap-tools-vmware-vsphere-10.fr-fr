...
NOTE: Une adresse IP des ONTAP tools doit correspondre à un nom de domaine complet (FQDN). Les certificats doivent contenir le même FQDN associé à l'adresse IP des ONTAP tools dans le champ subject ou subject alternative names.
