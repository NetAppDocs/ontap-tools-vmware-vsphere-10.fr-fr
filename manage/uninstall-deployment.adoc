...
[role="lead"]
La désinstallation des ONTAP tools for VMware vSphere supprime toutes les données dans les outils, vous devez donc suivre ces étapes pour terminer correctement votre déploiement et éviter toute perte de données inattendue.
