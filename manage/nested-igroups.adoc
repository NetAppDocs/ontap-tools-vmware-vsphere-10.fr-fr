...
sidebar: sidebar 
keywords:  
summary: Découvrez comment les ONTAP tools for VMware vSphere représentent et gèrent les igroups, y compris le comportement des igroups imbriqués, la réutilisation et les modifications de nettoyage de la version 10.5 P2. 
---
