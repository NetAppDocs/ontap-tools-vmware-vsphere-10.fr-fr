...
À partir des ONTAP tools for VMware vSphere 10.4, la gestion des banques de données est rationalisée en créant et en gérant automatiquement les objets ONTAP et vCenter dans les environnements de centre de données VMware.
