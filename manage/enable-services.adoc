...
sidebar: sidebar 
keywords:  
summary: 'Vous pouvez activer des services optionnels tels que VASA Provider, l"importation de vVols configuration et la reprise après sinistre (SRA) à l"aide de ONTAP tools Manager.' 
---
...
. Dans la section *Services*, vous pouvez activer, selon vos besoins, des services optionnels tels que VASA Provider, l'importation de la configuration vVols et la reprise après sinistre (SRA).
+
...
+
L'option *Autoriser l'importation de la configuration vVols * s'affiche uniquement lorsque le service VASA Provider est activé.  Cette option permet la migration des données vVols des outils ONTAP 9.xx vers les outils ONTAP 10.5.
