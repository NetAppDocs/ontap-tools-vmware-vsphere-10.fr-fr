...
+
.. Naviguez jusqu'à *NetApp ONTAP Tools* > *protection* > *Host cluster Relationships*, cliquez sur le menu points de suspension en regard du cluster et sélectionnez *Edit* or
