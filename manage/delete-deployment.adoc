...
+
Dans le cadre d'un déploiement haute disponibilité, quatre igroups sont créés et, dans un déploiement non HA, deux igroups sont créés.
Exécutez la commande suivante pour rechercher le premier nom de groupe initiateur :
