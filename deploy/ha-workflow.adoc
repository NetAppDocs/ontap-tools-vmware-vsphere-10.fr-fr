...
summary: 'Étendez un déploiement ONTAP tools à une configuration à haute disponibilité (HA) pour accroître la résilience et prendre en charge davantage de conteneurs par service.' 
---
...
[role="quick-margin-para"]
Pour configurer les banques de données vVols, vous devez activer le service VASA Provider. Enregistrez le fournisseur VASA auprès de vCenter et assurez-vous que vos politiques de stockage respectent les exigences de haute disponibilité, notamment en ce qui concerne la configuration correcte du réseau et du stockage.
