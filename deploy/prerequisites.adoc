...
== Limites de configuration pour la découverte du stockage backend

Les outils ONTAP prennent en charge la découverte du backend de stockage pour un maximum de 200 SVM et environ 10 000 LUN.
