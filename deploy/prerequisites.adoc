...
Vous pouvez utiliser ONTAP tools for VMware vSphere avec VMware vCenter Server Virtual Appliance (vCSA). Vous devez déployer ONTAP tools for VMware vSphere sur un environnement vSphere pris en charge qui inclut des hôtes ESXi.
