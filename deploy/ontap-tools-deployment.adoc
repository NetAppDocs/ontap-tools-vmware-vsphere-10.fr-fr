...
. Sélectionnez une ressource ordinateur et cliquez sur *Suivant*. Vous pouvez cocher la case *mettre automatiquement sous tension la machine virtuelle déployée*.
