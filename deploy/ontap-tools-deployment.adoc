...
. Choisissez le fichier OVA à partir de l'URL ou naviguez jusqu'à son emplacement, puis sélectionnez *Suivant*.
...
. Dans le champ *Sélectionner un nom et un dossier*, entrez le nom de la machine virtuelle et choisissez son emplacement. Si vous cochez la case *Personnaliser le matériel de cette machine virtuelle*, une étape supplémentaire appelée *Personnaliser le matériel* sera activée avant d'atteindre la fenêtre *prêt à terminer*.
...
. Dans la fenêtre *Personnaliser le matériel*, activez l'ajout à chaud de CPU et le plug-in mémoire.
