...
NOTE: ne supprimez pas le modèle OVA dans la bibliothèque de contenu après le déploiement.
...
. Dans la fenêtre *Personnaliser le modèle*, remplissez les champs obligatoires et sélectionnez *Suivant*.image:../media/sys-conf.png["Personnaliser le modèle"]
+
...
. Lorsque vous utilisez la version vCenter Server 8.0.3, dans la fenêtre *Personnaliser le matériel*, activez les options *Ajout à chaud du processeur* et *Prise à chaud de la mémoire* pour autoriser la fonctionnalité HA.image:../media/customize-hw105.png["Personnaliser le matériel"] image:../media/customize-hw.png["Personnaliser le matériel"]
