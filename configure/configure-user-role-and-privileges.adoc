...
.Avant de commencer
* Vous devez avoir téléchargé le fichier ONTAP Privileges depuis les outils ONTAP pour VMware vSphere à l'aide de _\https://<ONTAPtoolsIP>:8443/Virtualization/user-Privileges/Users_roles.zip_.
* Vous devez avoir téléchargé le fichier ONTAP Privileges à partir des outils ONTAP à l'aide de `\https://<ONTAPtoolsIP>:8443/virtualization/user-privileges/users_roles.zip`.
+
...
.Étapes
. Extrayez le fichier téléchargé _\https://<ONTAPtoolsIP>:8443/Virtualization/user-Privileges/Users_roles.zip_.
...
.. Sélectionnez les fonctionnalités du produit comme VSC, VASA Provider ou SRA dans la liste déroulante.
+
...
| /api/stockage/zones de disponibilité | Lecture seule | Découverte SAZ. Applicable aux systèmes ONTAP 9.16.1 et ASA r2. 
|===
...
À partir de ONTAP 9.16.1, mettez à niveau les outils ONTAP pour VMware vSphere 10.3 vers 10.4 utilisateurs.
