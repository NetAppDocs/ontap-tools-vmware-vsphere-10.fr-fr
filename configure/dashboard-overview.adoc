...
sidebar: sidebar 
keywords: user roles 
summary: Lorsque vous sélectionnez l’icône du plug-in ONTAP tools for VMware vSphere dans la section des raccourcis sur le client vCenter, l’interface utilisateur navigue vers la page de présentation. Cette page fait office de tableau de bord et fournit un résumé du plug-in ONTAP tools for VMware vSphere. 
---
