...
. Sélectionnez une machine virtuelle de stockage dans le volet *Stockage*. Indiquez le *Nom du groupe d'initiateurs personnalisé* dans la section *Options avancées* si nécessaire. Vous pouvez choisir un groupe d'initiateurs existant pour la banque de données ou en créer un nouveau avec un nom personnalisé.
+
